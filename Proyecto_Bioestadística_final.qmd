...
names(c_dpto)<-c("Departamento","Casos")
c_dpto$Departamento<-c("Amazonas","Áncash","Apurímac","Arequipa","Ayacucho","Cajamarca","Callao","Cusco","Huancavelica","Huánuco","Ica","Junin","La libertad","Lambayeque","Lima","Loreto","Madre de Dios","Moquegua","Pasco","Piura","Puno","San Martin","Tacna","Tumbes","Ucayali")

c_dpto

# Cargar datos geoespaciales de los departamentos del Perú
peru_departamentos <- st_read(dsn = "C:/Users/axime/Desktop/P_bioes/mapa/dp.shp")
peru_departamentos

# Fusionar los datos geoespaciales con la tabla de conteo por departamentos
peru

peru_departamentos <- merge(peru_departamentos, c_dpto, by.x = "NAME_1", by.y = "Casos")

ggplot() +
  geom_sf(data = peru_departamentos, aes(fill = Casos)) +
  scale_fill_viridis_c(name = "Casos") +
  theme_minimal()
